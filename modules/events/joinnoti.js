...
module.exports.run = async function ({ api, event, Users, Threads }) {
    ...
    if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
        ...
        try {
            ...
            let msg = (typeof threadData.customJoin == "undefined") ? "‎[ Group Member Joined ]\n─────────────────\n🎀 Welcome {name} to the group {threadName}.\n👤 {type} is the {soThanhVien}th member of the group\n🎀 {type} was added by: {author}\n⏰ Time: {time}\n📆 In the {session} {thu}" : threadData.customJoin;
